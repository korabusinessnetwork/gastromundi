...
| F015 | Via de produção impressa (`src/lib/impressao/impressao.js` → `montarViaProducao`, botão por comanda no KDS) — enxuta, sem preço, só itens produzíveis; fallback de impressão para quando a tela está indisponível | ✅ 2026-07-06 |
