...
-- ══════════════════════════════════════════════════════════════════════
-- [01/35]  20260918_delivery_nao_publica_insumo_nem_preco_zero.sql
-- ══════════════════════════════════════════════════════════════════════
DO $aplicando$ BEGIN RAISE NOTICE '▶ APLICANDO [01/35] 20260918_delivery_nao_publica_insumo_nem_preco_zero.sql'; END $aplicando$;
...
-- ══════════════════════════════════════════════════════════════════════
-- [02/35]  20260918_grupos_escolha.sql
-- ══════════════════════════════════════════════════════════════════════
DO $aplicando$ BEGIN RAISE NOTICE '▶ APLICANDO [02/35] 20260918_grupos_escolha.sql'; END $aplicando$;
...
-- ══════════════════════════════════════════════════════════════════════
-- [03/35]  20260919_baixa_estoque_cria_linha.sql
-- ══════════════════════════════════════════════════════════════════════
DO $aplicando$ BEGIN RAISE NOTICE '▶ APLICANDO [03/35] 20260919_baixa_estoque_cria_linha.sql'; END $aplicando$;
...
-- ══════════════════════════════════════════════════════════════════════
-- [04/35]  20260919_delivery_entregadores.sql
-- ══════════════════════════════════════════════════════════════════════
DO $aplicando$ BEGIN RAISE NOTICE '▶ APLICANDO [04/35] 20260919_delivery_entregadores.sql'; END $aplicando$;
...
-- ══════════════════════════════════════════════════════════════════════
-- [05/35]  20260919_pautas.sql
-- ══════════════════════════════════════════════════════════════════════
DO $aplicando$ BEGIN RAISE NOTICE '▶ APLICANDO [05/35] 20260919_pautas.sql'; END $aplicando$;
...
-- ══════════════════════════════════════════════════════════════════════
-- [06/35]  20260920_delivery_pagamento_entregador.sql
-- ══════════════════════════════════════════════════════════════════════
DO $aplicando$ BEGIN RAISE NOTICE '▶ APLICANDO [06/35] 20260920_delivery_pagamento_entregador.sql'; END $aplicando$;
...
-- ══════════════════════════════════════════════════════════════════════
-- [07/35]  20260920_rls_habilitada_tabelas_base.sql
-- ══════════════════════════════════════════════════════════════════════
DO $aplicando$ BEGIN RAISE NOTICE '▶ APLICANDO [07/35] 20260920_rls_habilitada_tabelas_base.sql'; END $aplicando$;
...
-- ══════════════════════════════════════════════════════════════════════
-- [08/35]  20260921_delivery_rate_limit_sem_telefone.sql
-- ══════════════════════════════════════════════════════════════════════
DO $aplicando$ BEGIN RAISE NOTICE '▶ APLICANDO [08/35] 20260921_delivery_rate_limit_sem_telefone.sql'; END $aplicando$;
...
-- ══════════════════════════════════════════════════════════════════════
-- [09/35]  20260921_indices_tenant_id.sql
-- ══════════════════════════════════════════════════════════════════════
DO $aplicando$ BEGIN RAISE NOTICE '▶ APLICANDO [09/35] 20260921_indices_tenant_id.sql'; END $aplicando$;
...
-- ══════════════════════════════════════════════════════════════════════
-- [10/35]  20260922_fiscal_config_leitura_por_papel.sql
-- ══════════════════════════════════════════════════════════════════════
DO $aplicando$ BEGIN RAISE NOTICE '▶ APLICANDO [10/35] 20260922_fiscal_config_leitura_por_papel.sql'; END $aplicando$;
...
-- ══════════════════════════════════════════════════════════════════════
-- [11/35]  20260922_gravar_itens_comanda.sql
-- ══════════════════════════════════════════════════════════════════════
DO $aplicando$ BEGIN RAISE NOTICE '▶ APLICANDO [11/35] 20260922_gravar_itens_comanda.sql'; END $aplicando$;
...
-- ══════════════════════════════════════════════════════════════════════
-- [12/35]  20260923_combo_produtos_isolamento_tenant.sql
-- ══════════════════════════════════════════════════════════════════════
DO $aplicando$ BEGIN RAISE NOTICE '▶ APLICANDO [12/35] 20260923_combo_produtos_isolamento_tenant.sql'; END $aplicando$;
...
-- ══════════════════════════════════════════════════════════════════════
-- [13/35]  20260923_dinheiro_precisao.sql
-- ══════════════════════════════════════════════════════════════════════
DO $aplicando$ BEGIN RAISE NOTICE '▶ APLICANDO [13/35] 20260923_dinheiro_precisao.sql'; END $aplicando$;
...
-- ══════════════════════════════════════════════════════════════════════
-- [14/35]  20260924_fechamentos_colunas.sql
-- ══════════════════════════════════════════════════════════════════════
DO $aplicando$ BEGIN RAISE NOTICE '▶ APLICANDO [14/35] 20260924_fechamentos_colunas.sql'; END $aplicando$;
...
-- ══════════════════════════════════════════════════════════════════════
-- [15/35]  20260924_search_path_security_definer.sql
-- ══════════════════════════════════════════════════════════════════════
DO $aplicando$ BEGIN RAISE NOTICE '▶ APLICANDO [15/35] 20260924_search_path_security_definer.sql'; END $aplicando$;
...
-- ══════════════════════════════════════════════════════════════════════
-- [16/35]  20260925_leads_apex.sql
-- ══════════════════════════════════════════════════════════════════════
DO $aplicando$ BEGIN RAISE NOTICE '▶ APLICANDO [16/35] 20260925_leads_apex.sql'; END $aplicando$;
...
-- ══════════════════════════════════════════════════════════════════════
-- [17/35]  20260925_ponte_download_bucket.sql
-- ══════════════════════════════════════════════════════════════════════
DO $aplicando$ BEGIN RAISE NOTICE '▶ APLICANDO [17/35] 20260925_ponte_download_bucket.sql'; END $aplicando$;
...
-- ══════════════════════════════════════════════════════════════════════
-- [18/35]  20260926_solicitacoes_conta.sql
-- ══════════════════════════════════════════════════════════════════════
DO $aplicando$ BEGIN RAISE NOTICE '▶ APLICANDO [18/35] 20260926_solicitacoes_conta.sql'; END $aplicando$;
...
-- ══════════════════════════════════════════════════════════════════════
-- [19/35]  20260927_grupo_escolha_itens_ativo.sql
-- ══════════════════════════════════════════════════════════════════════
DO $aplicando$ BEGIN RAISE NOTICE '▶ APLICANDO [19/35] 20260927_grupo_escolha_itens_ativo.sql'; END $aplicando$;
...
-- ══════════════════════════════════════════════════════════════════════
-- [20/35]  20260928_delivery_retirada_no_local.sql
-- ══════════════════════════════════════════════════════════════════════
DO $aplicando$ BEGIN RAISE NOTICE '▶ APLICANDO [20/35] 20260928_delivery_retirada_no_local.sql'; END $aplicando$;
...
-- ══════════════════════════════════════════════════════════════════════
-- [21/35]  20260929_delivery_sem_cep_e_meus_pedidos.sql
-- ══════════════════════════════════════════════════════════════════════
DO $aplicando$ BEGIN RAISE NOTICE '▶ APLICANDO [21/35] 20260929_delivery_sem_cep_e_meus_pedidos.sql'; END $aplicando$;
...
-- ══════════════════════════════════════════════════════════════════════
-- [22/35]  20260930_delivery_telefone_obrigatorio.sql
-- ══════════════════════════════════════════════════════════════════════
DO $aplicando$ BEGIN RAISE NOTICE '▶ APLICANDO [22/35] 20260930_delivery_telefone_obrigatorio.sql'; END $aplicando$;
...
-- ══════════════════════════════════════════════════════════════════════
-- [23/35]  20261001_delivery_via_sai_sozinha.sql
-- ══════════════════════════════════════════════════════════════════════
DO $aplicando$ BEGIN RAISE NOTICE '▶ APLICANDO [23/35] 20261001_delivery_via_sai_sozinha.sql'; END $aplicando$;
...
-- ══════════════════════════════════════════════════════════════════════
-- [24/35]  20261002_venda_do_delivery.sql
-- ══════════════════════════════════════════════════════════════════════
DO $aplicando$ BEGIN RAISE NOTICE '▶ APLICANDO [24/35] 20261002_venda_do_delivery.sql'; END $aplicando$;
...
-- ══════════════════════════════════════════════════════════════════════
-- [25/35]  20261003_delivery_whatsapp_no_aceite.sql
-- ══════════════════════════════════════════════════════════════════════
DO $aplicando$ BEGIN RAISE NOTICE '▶ APLICANDO [25/35] 20261003_delivery_whatsapp_no_aceite.sql'; END $aplicando$;
...
-- ══════════════════════════════════════════════════════════════════════
-- [26/35]  20261004_escolhas_sem_limite.sql
-- ══════════════════════════════════════════════════════════════════════
DO $aplicando$ BEGIN RAISE NOTICE '▶ APLICANDO [26/35] 20261004_escolhas_sem_limite.sql'; END $aplicando$;
...
-- ══════════════════════════════════════════════════════════════════════
-- [27/35]  20261005_desabilitar_produto_espelho.sql
-- ══════════════════════════════════════════════════════════════════════
DO $aplicando$ BEGIN RAISE NOTICE '▶ APLICANDO [27/35] 20261005_desabilitar_produto_espelho.sql'; END $aplicando$;
...
-- ══════════════════════════════════════════════════════════════════════
-- [28/35]  20261006_cliente_do_delivery.sql
-- ══════════════════════════════════════════════════════════════════════
DO $aplicando$ BEGIN RAISE NOTICE '▶ APLICANDO [28/35] 20261006_cliente_do_delivery.sql'; END $aplicando$;
...
-- ══════════════════════════════════════════════════════════════════════
-- [29/35]  20261007_delivery_sincroniza_produto_novo.sql
-- ══════════════════════════════════════════════════════════════════════
DO $aplicando$ BEGIN RAISE NOTICE '▶ APLICANDO [29/35] 20261007_delivery_sincroniza_produto_novo.sql'; END $aplicando$;
...
DO $aplicando$ BEGIN RAISE NOTICE '▶ APLICANDO [30/35] 20261008_regra_preco_grupo.sql'; END $aplicando$;
...
DO $aplicando$ BEGIN RAISE NOTICE '▶ APLICANDO [31/35] 20261009_integridade_do_historico.sql'; END $aplicando$;
...
DO $aplicando$ BEGIN RAISE NOTICE '▶ APLICANDO [32/35] 20261010_feedbacks.sql'; END $aplicando$;
...
DO $aplicando$ BEGIN RAISE NOTICE '▶ APLICANDO [33/35] 20261011_vitrine_mostra_grupos_do_produto.sql'; END $aplicando$;
...
DO $aplicando$ BEGIN RAISE NOTICE '▶ APLICANDO [34/35] 20261012_delivery_aceite_automatico.sql'; END $aplicando$;

-- ══════════════════════════════════════════════════════════════════
-- Aceite automático de pedidos no delivery (opção do estabelecimento).
--
-- ┌─ Por que ─────────────────────────────────────────────────────────┐
-- │ Hoje todo pedido nasce em 'recebido' e alguém precisa apertar     │
-- │ "Aceitar" para ele virar 'em_preparo'. Numa cozinha que aceita    │
-- │ tudo que entra, esse clique não decide nada: só atrasa o preparo  │
-- │ e, quando ninguém está olhando a tela, deixa o pedido parado      │
-- │ enquanto o cliente acha que está sendo feito.                     │
-- └────────────────────────────────────────────────────────────────────┘
--
-- Com `aceite_automatico` ligado, o pedido NASCE 'em_preparo'. Numa
-- transação só: não existe janela em que ele esteja 'recebido' sem ter
-- sido aceito, nem corrida entre dois painéis abertos ao mesmo tempo.
--
-- NASCE DESLIGADO. Quem não mexer em nada continua com o fluxo de hoje,
-- clique de aceite incluído.
--
-- O QUE NÃO MUDA:
--   • A recusa continua valendo antes de tudo: loja fechada, pedido
--     mínimo, endereço fora de área e item indisponível recusam o pedido
--     ANTES de ele existir. Aceite automático não aceita o que o sistema
--     já não aceitava — ele só pula o clique de quem ia aceitar mesmo.
--   • Cancelar continua possível ('em_preparo' → 'cancelado' é transição
--     válida no gatilho de status), então aceitar sozinho não é uma porta
--     sem volta.
--   • A via de produção já saía no momento do pedido (`launched_at` no
--     espelho), então nada muda para a impressora.
--
-- ATENÇÃO (tratado no front, não aqui): o aviso sonoro de pedido novo
-- filtrava por status 'recebido'. Com o aceite automático o pedido nunca
-- passa por lá — `detectarNovosPedidos` passou a alertar também o
-- 'em_preparo' inédito, senão a chave silenciaria a cozinha.
-- ══════════════════════════════════════════════════════════════════

ALTER TABLE public.config_delivery
  ADD COLUMN IF NOT EXISTS aceite_automatico boolean NOT NULL DEFAULT false;

COMMENT ON COLUMN public.config_delivery.aceite_automatico IS
  'Pedido novo já nasce em_preparo, sem o clique de aceitar.';

-- ── criar_pedido_delivery: o pedido nasce aceito quando a chave está on
--
-- A função vem LITERALMENTE da 20261011, com UMA mudança: o literal
-- 'recebido' do INSERT virou um CASE sobre a chave. Todo o resto — regra
-- de preço dos grupos, numeração, taxa, espelho em `pending`, cadastro do
-- cliente — é o mesmo texto.
...
BEGIN
  INSERT INTO public.tenants (nome, slug)
  VALUES ('Conferência 20261012', 'conf-20261012') RETURNING id INTO v_tenant;

  INSERT INTO public.products (tenant_id, name, price, category, active)
  VALUES (v_tenant, 'Marmita', 25, 'Pratos', true) RETURNING id INTO v_prod;
  ...
  INSERT INTO public.produto_delivery (tenant_id, produto_id, disponivel)
  VALUES (v_tenant, v_prod, true);

  -- A coluna nasce DESLIGADA: quem não mexer em nada segue com o clique.
  IF (SELECT aceite_automatico FROM public.config_delivery WHERE tenant_id = v_tenant) THEN
    RAISE EXCEPTION 'Aceite automático: a chave tinha de nascer desligada.';
  END IF;

  -- Desligada, o pedido nasce em 'recebido', como sempre.
  v_res := public.criar_pedido_delivery('conf-20261012', jsonb_build_object(
    ...
    'itens',     jsonb_build_array(jsonb_build_object('produto_id', v_prod, 'qtd', 1))
  ));
  SELECT status INTO v_status FROM public.delivery_pedidos
  WHERE tenant_id = v_tenant AND numero = v_res->>'numero';
  IF v_status <> 'recebido' THEN
    RAISE EXCEPTION 'Aceite automático desligado: esperava recebido, veio %.', v_status;
  END IF;

  -- Ligada, nasce já aceito.
  UPDATE public.config_delivery SET aceite_automatico = true WHERE tenant_id = v_tenant;
  v_res := public.criar_pedido_delivery('conf-20261012', jsonb_build_object(
    'cliente',   jsonb_build_object('nome', 'Ana', 'telefone', '51986557795'),
    'entrega',   jsonb_build_object('tipo', 'retirada'),
    'pagamento', jsonb_build_object('forma', 'pix'),
  ...
  IF v_status <> 'em_preparo' THEN
    RAISE EXCEPTION 'Aceite automático ligado: esperava em_preparo, veio %.', v_status;
  END IF;

  -- Aceitar sozinho não é porta sem volta: cancelar continua valendo.
  UPDATE public.delivery_pedidos SET status = 'cancelado'
  WHERE tenant_id = v_tenant AND numero = v_res->>'numero';

  -- E a recusa continua antes de tudo: com a loja FECHADA, o aceite
  -- automático não aceita nada — ele pula o clique, não a regra.
  UPDATE public.config_delivery SET aberto = false, horario = '{}'::jsonb
  WHERE tenant_id = v_tenant;
  BEGIN
    PERFORM public.criar_pedido_delivery('conf-20261012', jsonb_build_object(
      'cliente',   jsonb_build_object('nome', 'Ana', 'telefone', '51986557795'),
      'entrega',   jsonb_build_object('tipo', 'retirada'),
      'pagamento', jsonb_build_object('forma', 'pix'),
      'itens',     jsonb_build_array(jsonb_build_object('produto_id', v_prod, 'qtd', 1))));
    RAISE EXCEPTION 'Aceite automático: loja fechada tinha de recusar o pedido.';
  EXCEPTION WHEN OTHERS THEN
    IF SQLERRM LIKE 'Aceite automático:%' THEN RAISE; END IF;
  END;

  RAISE NOTICE 'Aceite automático conferido: nasce desligado, respeita a chave nos dois sentidos, deixa cancelar e não passa por cima da loja fechada.';
  ...
  -- 20261009). A cópia é justamente o que não se apaga por acidente, então
  -- a limpeza da conferência tem de tirá-la de propósito, e antes do tenant.
  DELETE FROM public.comandas_arquivadas WHERE tenant_id = v_tenant;
...
DO $aplicando$ BEGIN RAISE NOTICE '▶ APLICANDO [35/35] 20261013_opcao_com_quantidade.sql'; END $aplicando$;
