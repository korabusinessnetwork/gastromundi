...
- `references/claude-cookbooks.md` — se o produto usa IA em produção (agente,
  automação, extração de documento), building blocks curados do
  anthropics/claude-cookbooks mapeados pro padrão Kora. Consultar na Fase 3
  antes de fechar o ADR de arquitetura de IA.
