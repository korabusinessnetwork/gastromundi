...
export function getSizes(width) {
  ...
  if (width >= 3840) return {
    sidebarWidth:   360, comandaCardMin: 280, productCardMin: 240,
  ...
  if (width >= 2560) return {
    sidebarWidth:   300, comandaCardMin: 250, productCardMin: 210,
  ...
  if (width >= 1920) return {
    sidebarWidth:   260, comandaCardMin: 220, productCardMin: 185,
  ...
  if (width >= 1440) return {
    sidebarWidth:   240, comandaCardMin: 200, productCardMin: 165,
  ...
  if (width >= 1280) return {
    sidebarWidth:   220, comandaCardMin: 180, productCardMin: 148,
  ...
  if (width >= 1024) return {
    sidebarWidth:   200, comandaCardMin: 155, productCardMin: 130,
  ...
  // tablet: 768–1023
  if (width >= 768) return {
    sidebarWidth:   180, comandaCardMin: 140, productCardMin: 120,
  ...
  if (width < 360) return {
    sidebarWidth:     0, comandaCardMin: 110, productCardMin: 100,
    cartWidth:        0, checkoutResumo:   0,
  ...
  // mobile: 360–767
  return {
    sidebarWidth:     0, comandaCardMin: 140, productCardMin: 120,
    cartWidth:        0, checkoutResumo:   0,
