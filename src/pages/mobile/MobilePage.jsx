...
import { nomeExibicaoTenant } from "@/lib/tenant/tema";
import {
  totalLancamentosGarcom,
  radarOportunidades,
} from "@/lib/vendas/painelGarcom";
import {
  adicionarEspera,
  removerEspera,
  totalEspera,
  resumoEsperas,
} from "@/lib/vendas/pedidosEmEspera";
import { useTravaComanda } from "@/hooks/useTravaComanda";
import { travadaPorOutro, nomeTrava } from "@/lib/vendas/comandaLock";
import { cancelarItemComanda, totalItensAtivos } from "@/lib/vendas/comandaItens";
