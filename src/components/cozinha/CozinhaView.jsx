...
import { iniciarPreparo, marcarPronto, tempoDecorridoMin, estaAtrasado, formatarTempoDecorrido } from "@/lib/cozinha/cozinha";
 ...
 * aqui é a comanda em `pending` (ver src/lib/cozinha/cozinha.js).
 */
