...
import { emitirDocumentoFiscal } from "@/lib/fiscal/fiscal";
import { destDoCliente } from "@/lib/fiscal/nfceVenda";
import { processarPagamentoTef, metodoUsaTef } from "@/lib/vendas/tef";
import { consumoParaEstoque } from "@/utils/conversaoUnidades";
import { calcularBaixasSubprodutos, calcularBaixasProdutosCombo } from "@/lib/produtos/combos";
